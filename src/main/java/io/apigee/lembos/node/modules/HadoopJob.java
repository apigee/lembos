...
/**
 * Implementation of {@link NodeModule} that provides {@link JobWrap}.
 */
public final class HadoopJob implements NodeModule {

    public static final String MODULE_NAME = "hadoop-job";
    ...
    public Scriptable registerExports(final Context ctx, final Scriptable global, final NodeRuntime runtime)
        ...
        ScriptableObject.defineClass(exports, JobWrap.class);
