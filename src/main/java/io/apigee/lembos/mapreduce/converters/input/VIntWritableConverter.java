...
/**
 * Implementation of {@link WritableToJSConverter} for {@link VIntWritable}.
 */
public final class VIntWritableConverter implements WritableToJSConverter<VIntWritable> {
    ...
    public boolean canConvert(final Object jsObject) {
        return jsObject instanceof VIntWritable;
    }
