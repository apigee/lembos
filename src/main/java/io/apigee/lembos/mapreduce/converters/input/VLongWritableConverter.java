...
/**
 * Implementation of {@link WritableToJSConverter} for {@link VLongWritable}.
 */
public final class VLongWritableConverter implements WritableToJSConverter<VLongWritable> {
    ...
    public boolean canConvert(final Object jsObject) {
        return jsObject instanceof VLongWritable;
    }
